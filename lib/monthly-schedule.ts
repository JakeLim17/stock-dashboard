...
const CURATED_SCHEDULE: ScheduleEntry[] = [
  ...
  {
    id: "curated-2026-07-sk-square-spinoff",
    startDate: kstMidnight(2026, 7, 2),
    endDate: kstMidnight(2026, 7, 5),
    label: "SK스퀘어 지배구조·분할 전환 기대",
    kind: "custom",
    country: "kr",
    symbolCode: "402340.KS",
    importance: "medium",
    detail: "지주 구조 개선·분할 이슈 — 단기 지분가치 재평가 구간",
  },
  {
    id: "curated-2026-07-sk-holdings-spinoff",
    startDate: kstMidnight(2026, 7, 2),
    endDate: kstMidnight(2026, 7, 5),
    label: "SK 지주 — 계열 분할·구조개편 기대",
    kind: "custom",
    country: "kr",
    symbolCode: "034730.KS",
    importance: "medium",
    detail: "SK 계열 지배구조 이슈 — 하이닉스 ADR과 연동 모니터",
  },
  {
  ...
  },
  {
    ...
    endDate: kstMidnight(2026, 7, 18),
    label: "SK하이닉스 미국 ADR 상장",
    kind: "ipo",
    country: "kr",
    symbolCode: "000660.KS",
    importance: "high",
    detail: "미국 예탁증권(ADR) 상장 — 상장 직후·다음주 모멘텀 구간",
  },
  {
    id: "curated-2026-07-skhy-nasdaq",
    startDate: kstMidnight(2026, 7, 10),
    endDate: kstMidnight(2026, 7, 18),
    ...
    symbolCode: "SKHY",
    importance: "high",
    detail: "NASDAQ: SKHY 직상장 — 원주(000660)·반도체 피어 연동 호재",
  },
  {
