...
const KIS_REGULAR_REFRESH_MS = 1_000; // KIS 실데이터 정규장: 1초 (토스 수준 체감, kisGet throttle로 rate-limit 보호)
const KIS_EXTENDED_REFRESH_MS = 2_000; // KIS 실데이터 + 시간외 OPEN: 2초 (시간외 단일가는 호가 빈도가 낮아 더 줄여도 이득 없음)
